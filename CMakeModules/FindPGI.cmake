...
macro(__compiler_pgi lang)
  ...
  string(APPEND CMAKE_${lang}_FLAGS_DEBUG_INIT " -g -O0 -std=c++0x")
  string(APPEND CMAKE_${lang}_FLAGS_MINSIZEREL_INIT " -O2 -s-std=c++0x")
  string(APPEND CMAKE_${lang}_FLAGS_RELEASE_INIT " -fast -O3 -std=c++0x")
  string(APPEND CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT " -O2 -gopt -std=c++0x  ")
